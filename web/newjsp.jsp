...
<html>
    ...
    <body>
        <div class="container">
            <form method="POST" action="sertifikatServlet">
                ...
                <div class="form-group">
                    ...
                    <input name="lembaga" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter email">
                </div>
                <div class="form-group">
