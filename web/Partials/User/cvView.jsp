            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    <div class="card shadow p-3 mb-3 bg-white rounded mt-3" style="width: 22rem;">
                        ...
                        <div class="card-body">
                            <h4 class="card-title"><%= namas%></h4>
                            <footer class="blockquote-footer"><a href="Partials/User/userProfileViews.jsp">Edit profile</a></footer>
                        ...
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item">
                                ...
                                %>
                                <p class="mb-1"> <%= bhs.getIdBahasa().getNama()%> </p>
                                <% } %>
                            </li>
                            <li class="list-group-item">
