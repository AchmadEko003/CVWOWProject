 ...
 * @author Igaz
 */
@WebServlet(name = "DeleteRequirement", urlPatterns = {"/deleteRequirement"})
public class DeleteRequirement extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            Requirements bhs = (Requirements) ri.getById(new Requirements(), id);
            ri.delete(id, bhs.getNama());
            response.sendRedirect("view/reqView.jsp");
        }
    }
