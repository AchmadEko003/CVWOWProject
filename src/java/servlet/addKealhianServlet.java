 ...
 * @author Nitani
 */
@WebServlet(name = "addKealhianServlet", urlPatterns = {"/addKealhianServlet"})
public class addKealhianServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String nama = request.getParameter("keahlian");
