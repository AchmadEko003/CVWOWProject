 ...
 * @author Nitani
 */
@WebServlet(name = "addSertifikatServlet", urlPatterns = {"/addSertifikatServlet"})
public class addSertifikatServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String deskripsi = request.getParameter("lembaga");
